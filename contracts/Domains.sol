...
contract Domains is ERC721URIStorage {
    ...
    constructor(
        string memory _tld
    ) payable ERC721("Pirate Name Service", "PNS") {
    ...
    function register(string calldata name) public payable {
        ...
        console.log(
            "Registered %s.%s on the contract with tokenID %d",
            name,
            tld,
            newRecordId
        );
        ...
        string memory json = Base64.encode(
            abi.encodePacked(
                '{"name": "',
                _name,
                '", "description": "A domain on the Pirate name service", "image": "data:image/svg+xml;base64,',
    ...
    function getAllNames() public view returns (string[] memory) {
        console.log("Getting all the names from contract");
...
// 0x9E6e747914deBc17A6e5b8a37379B0c35cf20064
